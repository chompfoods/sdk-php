...
/**
 * RecipeObjectAttributes Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecipeObjectAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecipeObject_attributes';
...
'serving_size' => 'getServingSize'    ];
     ...
     * Sets prep_time
     *
     * @param string $prep_time The time it takes to prep this recipe
     *
     * @return $this
     */
     ...
     * Sets total_time
     *
     * @param string $total_time The total time it takes to make this recipe
     *
     * @return $this
     */
     ...
     * Sets servings
     *
     * @param string $servings The number of servings this recipe makes
     *
     * @return $this
     */
     ...
     * Sets serving_size
     *
     * @param string $serving_size The size of each serving
     *
     * @return $this
     */
